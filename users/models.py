...
class Device(models.Model):
    ...
    #     _('M'), max_length=200, blank=True,
    #     validators=[validators.RegexValidator(r'([a-z]|[A-z]|[0-9])\w+'), _('N'), 'invalid']
    # )
    last_login = models.DateTimeField(_('last'), null=True)
    ...
    device_model = models.CharField(_('app version'), max_length=20, blank=True)
